...
class TestController: UIViewController {
    ...
    func example7() {
        ...
        tableView.ms_addRefreshHeader(header, refreshHandler: {[weak self] in
            ...
            dispatch_async(dispatch_get_global_queue(0, 0), {
                ...
                dispatch_async(dispatch_get_main_queue(), {
                    ...
                    /// 刷新完毕, 停止动画
                    self?.tableView.ms_stopHeaderAnimation()
        ...
        tableView.ms_addRefreshFooter(footer) {[weak self] in
            ...
            dispatch_async(dispatch_get_global_queue(0, 0), {
                ...
                dispatch_async(dispatch_get_main_queue(), {
                    self?.tableView.reloadData()
                    self?.tableView.ms_stopFooterAnimation()
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        //        tableView.ms_startHeaderAnimation()
